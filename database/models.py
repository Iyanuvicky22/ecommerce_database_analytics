...
class CustomersTable(Base):
    ...
    customers = relationship("OrdersTable", back_populates="orders")
...
class OrdersTable(Base):
    ...
    order_items = relationship("OrderItemsTable", back_populates="order")
    orders = relationship("CustomersTable", back_populates="customers")
...
class Products(Base):
    ...
    order_items = relationship("OrderItemsTable", back_populates="product")
...
class OrderItemsTable(Base):
    ...
    __table_args__ = (Index("idx_product_sales", "product_id"),)
